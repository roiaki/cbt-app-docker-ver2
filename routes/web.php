...
// 出来事に関して
Route::get('events/serch', 'App\Http\Controllers\EventsController@serchIndex')->name('events.serch');
...
// 3コラムに関して
Route::get('three_columns/serch', 'App\Http\Controllers\ThreeColumnsController@serchIndex')->name('three_columns.serch');
...
// 7コラムに関して
Route::get('seven_columns/serch', 'App\Http\Controllers\SevenColumnsController@serchIndex')->name('seven_columns.serch');
